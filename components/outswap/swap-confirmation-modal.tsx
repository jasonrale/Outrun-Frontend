        ...
        >
          <GradientBackgroundCard className="relative p-6 max-w-md w-full mx-4 text-white">
            <div className="flex justify-between items-center mb-4">
              <h2 className="text-xl font-bold bg-gradient-to-r from-purple-400 via-pink-500 to-blue-500 text-gradient-fill">
                {showSuccess ? "Transaction Status" : "You're swapping"}
              </h2>
              <button
                className="rounded-lg p-1 text-purple-400 transition-all duration-300 hover:bg-white/10 hover:text-pink-400 flex items-center justify-center"
                onClick={handleClose}
