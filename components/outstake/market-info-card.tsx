            ...
            {isYieldPoolActive ? (
              ...
              <>
                ...
                <div className="flex items-start gap-2 p-2.5 bg-gradient-to-r from-purple-500/10 to-pink-500/10 rounded-lg border border-purple-400/20">
                  <div className="w-1.5 h-1.5 bg-purple-400 rounded-full mt-1.5 flex-shrink-0"></div>
                  <div className="text-white/90 text-sm">
                    <span className="font-semibold text-purple-400">Wrap Staking 1 {marketData.assetName}</span> can
                    mint{" "}
              ...
              // Show normal information when neither isYieldPoolActive nor wrapStake is true
              <>
                <div className="flex items-start gap-2 p-2.5 bg-gradient-to-r from-purple-500/10 to-pink-500/10 rounded-lg border border-purple-400/20">
                  <div className="w-1.5 h-1.5 bg-purple-400 rounded-full mt-1.5 flex-shrink-0"></div>
                  <div className="text-white/90 text-sm">
                    ...
                    <div className="space-y-1.5">
                      ...
                      <div className="flex items-start gap-2">
                        ...
                        <div className="text-white/90 text-sm">
                          ...
                          <span className="font-semibold text-pink-400">
                            {marketData.mtv} {marketData.UPT?.symbol} stablecoin
                          </span>
                          .
                        </div>
                      </div>
