...
export function MarketInfoCard({ marketData, mintUPT, hideTitle = false, wrapStake = false }: MarketInfoCardProps) {
            ...
            {wrapStake ? (
              <>
                <div className="flex items-start gap-2 p-2.5 bg-gradient-to-r from-cyan-500/10 to-blue-500/10 rounded-lg border border-cyan-400/20">
                  ...
                  <div className="text-white/90 text-sm">
                    <span className="font-semibold text-cyan-400">
                      Wrap Staking 1 {marketData.underlyingAssetSymbol}
                    </span>{" "}
                    can mint <span className="font-semibold text-white">1 {marketData.UPT?.symbol}</span>.
                  </div>
                </div>
                <div className="flex items-start gap-2 p-2.5 bg-gradient-to-r from-purple-500/10 to-pink-500/10 rounded-lg border border-purple-400/20">
                  ...
                  <div className="text-white/90 text-sm">
                    <span className="font-semibold text-purple-400">Wrap Staking 1 {marketData.assetName}</span> can mint{" "}
                    <span className="font-semibold text-pink-400">
                      {marketData.exchangeRate?.toFixed(6)} {marketData.UPT?.symbol}
                    </span>
                    .
                  </div>
                </div>
              ...
              // Show normal information when wrapStake is false
              <>
                <div className="flex items-start gap-2 p-2.5 bg-gradient-to-r from-purple-500/10 to-pink-500/10 rounded-lg border border-purple-400/20">
                  <div className="w-1.5 h-1.5 bg-purple-400 rounded-full mt-1.5 flex-shrink-0"></div>
                  <div className="text-white/90 text-sm">
                ...
                {mintUPT && (
                  <div className="p-2.5 bg-gradient-to-r from-pink-500/10 to-purple-500/10 rounded-lg border border-pink-400/20">
                    <div className="space-y-1.5">
                      <div className="flex items-start gap-2">
                        <div className="w-1.5 h-1.5 bg-pink-400 rounded-full mt-1.5 flex-shrink-0"></div>
                        <div className="text-white/90 text-sm">
                          <span className="font-semibold text-purple-400">Mint-to-Value Ratio (MTV)</span> ={" "}
                          <span className="font-semibold text-pink-400">{marketData.mtv}</span>.
                        </div>
                      </div>
                      <div className="flex items-start gap-2">
                        <div className="w-1.5 h-1.5 bg-pink-400 rounded-full mt-1.5 flex-shrink-0"></div>
                        <div className="text-white/90 text-sm">
                          <span className="font-semibold text-purple-400">1 SP {marketData.assetName}(expired)</span>{" "}
                          can be split into{" "}
                          <span className="font-semibold text-pink-400">1 {marketData.UPT?.symbol} stablecoin</span>.
                        </div>
                      </div>
                      <div className="flex items-start gap-2">
                        <div className="w-1.5 h-1.5 bg-pink-400 rounded-full mt-1.5 flex-shrink-0"></div>
                        <div className="text-white/90 text-sm">
                          <span className="font-semibold text-purple-400">1 SP {marketData.assetName}(unexpired)</span>{" "}
                          can be split into a maximum of{" "}
                          <span className="font-semibold text-pink-400">{marketData.mtv} {marketData.UPT?.symbol} stablecoin</span>.
                        </div>
                      </div>
                    </div>
                  </div>
